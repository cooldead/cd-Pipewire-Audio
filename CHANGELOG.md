...
- Tracks the focused KWin window PID and matches it to PipeWire `application.process.id`.
- Added PID-based volume and mute commands, including Proton/Wine application streams.
- Added a bundled KWin script and installer helper.
...
- Renamed the plugin to **"CooldeadPipeWire (Native)"** to avoid a display-name
...
[Unreleased]: https://github.com/sjourdois/cooldeadpipewire/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/sjourdois/cooldeadpipewire/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/sjourdois/cooldeadpipewire/compare/v0.1.1...v0.2.0
[0.1.1]: https://github.com/sjourdois/cooldeadpipewire/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/sjourdois/cooldeadpipewire/releases/tag/v0.1.0
